...
func (t *tachibanaApi) fromStreamResponse(res tachibana.StreamResponse) *pb.StreamResponse {
	...
	case *tachibana.MarketPriceStreamResponse:
		return t.fromMarketPriceStreamResponse(v)
...
func (t *tachibanaApi) fromMarketPriceStreamResponse(res *tachibana.MarketPriceStreamResponse) *pb.StreamResponse {
	return &pb.StreamResponse{
		EventType:      t.fromEventType(res.EventType),
		StreamNumber:   res.StreamNumber,
		StreamDateTime: timestamppb.New(res.StreamDateTime),
		...
		Body:           res.Body,
		IsFirstTime:    true,
		MarketPriceStreamResponse: &pb.MarketPriceStreamResponse{
			ColumnNumber:      int64(res.ColumnNumber),
			IssueCode:         "",
			Exchange:          pb.Exchange_EXCHANGE_UNSPECIFIED,
			Section:           res.Section,
			CurrentPrice:      res.CurrentPrice,
			CurrentPriceTime:  timestamppb.New(res.CurrentPriceTime),
			ChangePriceType:   t.fromChangePriceType(res.ChangePriceType),
			PrevDayRatio:      res.PrevDayRatio,
			PrevDayPercent:    res.PrevDayPercent,
			OpenPrice:         res.OpenPrice,
			OpenPriceTime:     timestamppb.New(res.OpenPriceTime),
			...
			Volume:            res.Volume,
			AskSign:           t.fromIndicationPriceType(res.AskSign),
			AskPrice:          res.AskPrice,
			AskQuantity:       res.AskQuantity,
			BidSign:           t.fromIndicationPriceType(res.BidSign),
			BidPrice:          res.BidPrice,
			BidQuantity:       res.BidQuantity,
			ExRightType:       res.ExRightType,
			DiscontinuityType: res.DiscontinuityType,
			StopHigh:          t.fromCurrentPriceType(res.StopHigh),
			StopLow:           t.fromCurrentPriceType(res.StopLow),
			TradingAmount:     res.TradingAmount,
			AskQuantityMarket: res.AskQuantityMarket,
			BidQuantityMarket: res.BidQuantityMarket,
			AskQuantityOver:   res.AskQuantityOver,
			AskQuantity10:     res.AskQuantity10,
			AskPrice10:        res.AskPrice10,
			AskQuantity9:      res.AskQuantity9,
			AskPrice9:         res.AskPrice9,
			AskQuantity8:      res.AskQuantity8,
			AskPrice8:         res.AskPrice8,
			AskQuantity7:      res.AskQuantity7,
			AskPrice7:         res.AskPrice7,
			AskQuantity6:      res.AskQuantity6,
			AskPrice6:         res.AskPrice6,
			AskQuantity5:      res.AskQuantity5,
			AskPrice5:         res.AskPrice5,
			AskQuantity4:      res.AskQuantity4,
			AskPrice4:         res.AskPrice4,
			AskQuantity3:      res.AskQuantity3,
			AskPrice3:         res.AskPrice3,
			AskQuantity2:      res.AskQuantity2,
			AskPrice2:         res.AskPrice2,
			AskQuantity1:      res.AskQuantity1,
			AskPrice1:         res.AskPrice1,
			BidQuantity1:      res.BidQuantity1,
			BidPrice1:         res.BidPrice1,
			BidQuantity2:      res.BidQuantity2,
			BidPrice2:         res.BidPrice2,
			BidQuantity3:      res.BidQuantity3,
			BidPrice3:         res.BidPrice3,
			BidQuantity4:      res.BidQuantity4,
			BidPrice4:         res.BidPrice4,
			BidQuantity5:      res.BidQuantity5,
			BidPrice5:         res.BidPrice5,
			BidQuantity6:      res.BidQuantity6,
			BidPrice6:         res.BidPrice6,
			BidQuantity7:      res.BidQuantity7,
			BidPrice7:         res.BidPrice7,
			BidQuantity8:      res.BidQuantity8,
			BidPrice8:         res.BidPrice8,
			BidQuantity9:      res.BidQuantity9,
			BidPrice9:         res.BidPrice9,
			BidQuantity10:     res.BidQuantity10,
			BidPrice10:        res.BidPrice10,
			BidQuantityUnder:  res.BidQuantityUnder,
			Vwap:              res.VWAP,
			Prp:               res.PRP,
		},
	}
